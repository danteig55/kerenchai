            ...
            <div className="space-y-8">
              <div className="bg-card rounded-2xl p-8 subtle-shadow">
                ...
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li>• Descontos de 5% a 15% em produtos essenciais</li>
              ...
              <div className="bg-card rounded-2xl p-8 subtle-shadow">
                ...
                <ul className="space-y-2 text-sm text-muted-foreground">
                  ...
                  <li>• Kits especiais para outras festividades</li>
                </ul>
              </div>
              ...
              <div className="bg-card rounded-2xl p-8 subtle-shadow">
                ...
                <p className="text-muted-foreground mb-4">
                  Através de sorteios e ações específicas, oferecemos refeições completas de Shabat 
                  e vales para itens essenciais como eletrodomésticos.
                </p>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li>• Refeições de Shabat entregues em casa</li>
                  <li>• Vales para eletrodomésticos essenciais</li>
